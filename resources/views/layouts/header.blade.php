<nav class="navbar nav-extended no-padding teal lighten-1">
    ...
    <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right">
            ...
            <li>
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="waves-effect dark-primary-color-text" type="submit">Cerrar sesión</a>
            </li>
